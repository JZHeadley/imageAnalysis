...
// Declaring my own types so I don't have to link OpenCV to my imageAnalysisLib even though its probably about the same as theirs just with fewer features
// Should be a little more easier to use whatever imageAnalysisLib you want to read in with as well since it just needs to be converted to this format
