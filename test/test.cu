...
//                    vector<float> features = extractAllPixelsAsFeatures(d_image);
    ...
    printf("Total time required for a tenfold cross validation knn with k of %i on %i instances with %i features: %0.4f ms achieved accuracy of %0.4f%, precision of: %f, and recall of %f\n",
            k,numInstances,
